...
#### Problem
Going through tons of job posting in [MyCareersFuture portal](https://www.mycareersfuture.gov.sg){:target="_blank" rel="noreferrer"} has been a daily morning chore for me. Despite the site having a job alert feature, it does not serve my needs. So I decided to take this opportunity to practice my Git and Python skills.
...
On top of that, I asked a friend of mine who is working in HR which other popular job seeking platform. He told me [LinkedIn Jobs](https://sg.linkedin.com/jobs){:target="_blank" rel="noreferrer"} is another common platform used by recruitment firm. So my next challenge would be adding JobStreet and LinkedIn Jobs into the script!
***

You can find the scripts in my [GitHub Repository](https://github.com/jinhoe/job-alert){:target="_blank" rel="noreferrer"}.
