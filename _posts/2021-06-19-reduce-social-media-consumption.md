...
{% include image.html src="/assets/images/reduce-social-media-consumption/ios-screen-time.jpeg" caption="Set up Screen Time limit" %}
...
{% include image.html src="/assets/images/reduce-social-media-consumption/delete-from-home-screen.jpeg" caption="Remove app from Home Screen and use search" %}
