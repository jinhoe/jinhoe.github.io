<nav class="archive archive-posts">
    ...
    <div class="archive-latest">
        <h3 class="archive-subtitle archive-latest-subtitle"><?= date('F') ?>'s <?= $site->archivePreviewTitle()->html() ?></h3>
    ...
    foreach ($posts as $p) : ?>
        ...
        <?php if ($p->published()->toDate('Yn') == $posts->first()->published()->toDate('Yn')) continue; ?>
